...
use rocket::State;
use shared::{
    Channel, HurdleClearResult, CreateHurdleMessage, HurdleMessage, MessageStatus, ResponseTimeStats,
    Urgency,
};
use sqlx::SqlitePool;
...
#[post("/hurdles/<id>/clear")]
pub async fn clear(pool: &State<SqlitePool>, id: i64) -> Result<Json<HurdleClearResult>, Status> {
