use crate::seeding::SeedNewMessage;
...
pub trait CourseGenerator: Send + Sync {
    fn generate(&self, difficulty: Difficulty, count: usize, seed: u64) -> Vec<SeedNewMessage>;
}
...
mod tests {
    ...
    fn urgency_severity_ratio(messages: &[SeedNewMessage]) -> f64 {
        let severe = messages
            .iter()
    ...
    fn positive_ratio(messages: &[SeedNewMessage]) -> f64 {
